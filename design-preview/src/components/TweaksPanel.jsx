...
const TWEAKS_STYLE = `
  ...
  .twk-toggle[data-on="1"]{background:#e10600}
  ...
  .twk-fab{position:fixed;right:16px;bottom:16px;z-index:2147483645;
    ...
    box-shadow:0 2px 12px rgba(0,0,0,.5);transition:transform 0.15s,background 0.15s}
  .twk-fab:hover{background:rgba(40,40,40,0.95);transform:scale(1.05)}
  .twk-fab svg{opacity:0.7}
`;
...
export function TweaksPanel({ title = 'Theme Designer', children }) {
  const [open, setOpen] = useState(false);
  const dragRef = useRef(null);
  const offsetRef = useRef({ x: 16, y: 56 });
  const PAD = 16;
  ...
  return (
    <>
      ...
      <button className="twk-fab" onClick={() => setOpen(o => !o)} title="Theme Designer">
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
          <circle cx="8" cy="8" r="2.5" fill="#e10600"/>
          <path d="M8 1v2M8 13v2M1 8h2M13 8h2M3.05 3.05l1.41 1.41M11.54 11.54l1.41 1.41M11.54 4.46l-1.41 1.41M4.95 11.54l-1.41 1.41" stroke="#888" strokeWidth="1.5" strokeLinecap="round"/>
        </svg>
      </button>
    </>
  );
