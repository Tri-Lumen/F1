...
export default function LiveError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <div className="rounded-xl border border-f1-border bg-f1-card p-8 text-center">
        <h2 className="text-xl font-bold mb-2">Failed to load live timing</h2>
        <p className="text-sm text-f1-text-muted mb-6">
          Live session data could not be fetched. This may be a temporary issue.
        </p>
