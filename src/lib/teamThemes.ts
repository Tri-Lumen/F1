...
export const CURRENT_TEAMS: TeamTheme[] = [
  {
    ...
    // bg, card, border, accent (gold), accentSecondary (American red)
  ...
  },
  {
    ...
    // bg, card, border, accent (white), accentSecondary (silver) — black & white livery
    previewColors: ["#0C0C0C", "#1E1E1E", "#333333", "#FFFFFF", "#AAAAAA"],
    colors: {
      bg: "#0C0C0C",
      dark: "#141414",
      card: "#1E1E1E",
